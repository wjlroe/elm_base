...
var _user$project$Components_ArticleList$renderArticle = function (article) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Article$view(article),
			_1: {ctor: '[]'}
		});
};
var _user$project$Components_ArticleList$articles = {
	ctor: '::',
	_0: {title: 'Article 1', url: 'http://google.com', postedBy: 'Author 1', postedOn: '20/06/16'},
	_1: {
		ctor: '::',
		_0: {title: 'Article 2', url: 'http://google.com', postedBy: 'Author 2', postedOn: '20/06/16'},
		_1: {
			ctor: '::',
			_0: {title: 'Article 3', url: 'http://google.com', postedBy: 'Author 3', postedOn: '20/06/16'},
			_1: {ctor: '[]'}
		}
	}
};
